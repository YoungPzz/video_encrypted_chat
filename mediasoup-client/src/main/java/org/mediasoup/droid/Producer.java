...
public class Producer {
  ...
  public void setFrameEncryptor(org.webrtc.HCCrypto encryptor) throws MediasoupException {
    nativeSetFrameEncryptor(mNativeProducer, encryptor.getNativeHCCrypto());
  }
  ...
  private static native void nativeSetFrameEncryptor(long producer, long track);
